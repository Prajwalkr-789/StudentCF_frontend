  ...
  return (
    <div className="min-h-screen transition-colors duration-300 dark:bg-black p-1 md:p-12">
      <div className="flex items-center gap-2 mb-4">
        ...
        <h2 className="text-xl font-bold text-zinc-900 dark:text-zinc-100">Problem Solving</h2>
      </div>
        ...
        <div className="p-8 rounded-xl shadow-lg bg-white dark:bg-zinc-950 dark:border border-zinc-700">
          ...
          <div className="grid grid-cols-2 gap-6">
            <div className="space-y-2">
              ...
              <p className="text-3xl font-bold text-orange-500">{mostDifficult?.rating || "0"}</p>
            </div>
            <div className="space-y-2">
              <p className="text-sm text-gray-600 dark:text-gray-400">Total Solved</p>
              <p className="text-3xl font-bold text-blue-500">{problemsSolved}</p>
            </div>
            <div className="space-y-2">
              <p className="text-sm text-gray-600 dark:text-gray-400">Average Rating</p>
              <p className="text-3xl font-bold text-green-500">{avgProblemRating}</p>
            </div>
            <div className="space-y-2">
  ...
  {barData && barData.length > 0 ? (
    ...
    <div className="flex flex-col items-center justify-center text-center space-y-2">
      <svg
        ...
        stroke="currentColor"
      >
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9.75 9.75h.008v.008H9.75V9.75zm4.5 0h.008v.008h-.008V9.75zm-4.5 4.5h.008v.008H9.75v-.008zm4.5 0h.008v.008h-.008v-.008z" />
        <path
          strokeLinecap="round"
      ...
      <p className="text-gray-500 dark:text-gray-400 text-xs">Try changing the date range.</p>
    </div>
  )}
</div>
